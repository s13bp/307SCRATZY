    ...
    [673], {
        3606: function(e, t, n) {
            ...
            let {
                clamp: y,
                lerp: h
            } = o.MathUtils, m = (e, t) => e.find(e => e.name === t), f = e => {
                let {
                    height: t,
                    model: n,
                    bodyRef: r,
                    ...
                    grpRef: u,
                    player: h
                } = e, [f, g] = (0, i.useState)(!1), x = (0, i.useRef)(), v = (0, i.useRef)(), w = (0, i.useRef)(null), b = (0, i.useRef)(null);
                return (0, i.useEffect)(() => {
                    ...
                    let h = new o.Object3D,
                        ...
                        M = new o.Object3D,
                        V = new o.Object3D;
                    e.add(i), i.add(s), s.add(f), f.add(M), M.add(V), f.add(p), h.add(e), p.memoQuaternion = new o.Quaternion, p.memoQuaternion.copy(p.quaternion), i.memoQuaternion = new o.Quaternion, i.memoQuaternion.copy(i.quaternion), p.memoTargetQuaternion = new o.Quaternion, i.memoTargetQuaternion = new o.Quaternion, p.memoTargetQuaternion.needUpdateTarget = !0, i.memoTargetQuaternion.needUpdateTarget = !0, p.memoTargetQuaternion.rotateWithoutUpdateCnt = 0, i.memoTargetQuaternion.rotateWithoutUpdateCnt = 0, h.scale.set(y(t, 0, 1), t, y(t, 0, 1)), f.scale.set(y(1 / t, 1, 1.6), y(1 / t, 1, 1.6), y(1 / t, 1, 1.6));
                    let S = new o.Object3D;
                    return r.current = h, a.current = f, b.current = p, w.current = i, x.current = M, v.current = V, e.add(S), u.current.objectY = S, u.current.memoTargetPlayerId = null, u.current.needUpdateTarget = !0, u.current.withoutUpdateCnt = 0, u.current.add(h), l === (0, d.PR)().id && (0, c.EA)({
                        localModel: n
                    }), g(!0), () => {
                        u.current && (u.current.remove(S), u.current.remove(h))
                    }
                }, [n]), (0, p.iD)(u.current, l, x, v, w, b, h), null
            };
            var g = n(2359),
                x = n(6038),
                v = n(6086),
            ...
            function V(e) {
                let {
                    ...
                    playerId: n,
                    player: o
                } = e, [p, y, h] = (0, c.WL)(e => [e.instance, e.animations, e.dummy]), m = (0, i.useRef)(), V = (0, i.useRef)(), S = (0, i.useMemo)(() => {
                ...
                return (0, l.A)((e, r) => {
                    ...
                    o.dirVector.copy(s.AJ).applyQuaternion(t.current.quaternion), s.Wv.resetToDefault(), o.upVector.copy(s.Wv).applyQuaternion(t.current.quaternion), o.eyePosition.copy(o.upVector).multiplyScalar((0, s.oC)(n, !0, o)).add(t.current.position), i.setMatrixAt(a, S.matrixWorld), i.geometry.attributes.height.array[a] = o.heightLerp, o.flyLerp = b(o.flyLerp, o.fly ? 1 : 0, 6, r);
                    let {
                        flyLerp: y
                    } = o;
                    i.geometry.attributes.fly.array[a] = y, o.color.toArray(i.geometry.attributes.instanceVColor.array, 3 * a), i.geometry.attributes.holo.array[a] = o.holo, i.setBonesAt(a, S.skeleton), (0, u.Kn)("postAnimRaf_".concat(n), r)
                }), (0, i.useEffect)(() => {
                    n === (0, d.PR)().id && (0, c.EA)({
                        characterModel: j
                    })
                }, [j]), (0, u.zX)("anim_holo_tp_".concat(n), e => {
                    let {
                        teleportingOut: t = !1,
                        reset: r = !1,
                        callBack: i = () => {}
                    ...
                    x.ZP.to(h, {
                        ...
                        onComplete: function() {
                            ...
                            S.position.y = 0, S.updateMatrixWorld(), y.setMatrixAt(e, S.matrixWorld), n === (0, d.PR)().id && (0, v.Q2)().physicReady && (p.sleep = !1), i()
                        }
                    })
                }), (0, i.useEffect)(() => {
                    if (n === (0, d.PR)().id) {
                        let {
                            ref: e,
                            instance: t
                        } = (0, c.XV)(), r = s.Fm.indexOf(o);
                        o.holo = 0, t.geometry.attributes.holo.array[r] = o.holo, t.geometry.attributes.holo.needsUpdate = !0, S.position.y = 0, S.updateMatrixWorld(), t.setMatrixAt(r, S.matrixWorld)
                    }
                }, [n, o]), S && n ? (0, r.jsx)(f, {
                    model: S,
                    height: o ? o.height : 1,
        ...
        1799: function(e, t, n) {
            ...
            let y = e => {
                let {
                    ...
                    backShape: n,
                    borderColor: r,
                    backgroundColor: o = 3421236,
                    ...a
                } = e;
                return (0, i.jsxs)("mesh", {
                    position: [0, 0, 0],
                    ...a,
                    children: [(0, i.jsx)("shapeGeometry", {
                        args: [t]
                    }), (0, i.jsx)(d.Z, {
                        color: r
                    }), (0, i.jsxs)("mesh", {
            ...
            let m = e => {
                let {
                    ...
                    maxWidth: 0,
                    heightText: 0
                }), []), x = (0, l.useRef)(null), [v, w] = (0, l.useState)({
                    borderShape: new s.Shape,
                    backShape: new s.Shape
                }), b = (0, h.y0)().font, M = e => {
                    x.current && x.current.children[e] && x.current.children[e].sync(t => {
                        if (!x.current || !x.current.children[e]) return;
                        let n = x.current.children[e].geometry._blockBounds;
                        0 === e ? (g.widthText = Math.abs(n[0]) + Math.abs(n[2]), g.heightText = Math.abs(n[1]) + Math.abs(n[3])) : g.widthPeudo = Math.abs(n[0]) + Math.abs(n[2]), g.mawWidth = Math.max(g.widthText, g.widthPeudo), V(), S()
                    })
                };
                (0, c.zX)("updateFont", e => {
                    let {
                ...
                let V = () => {
                        x.current.children[0].position.y = g.heightText / 2, x.current.children[0].position.x = -g.mawWidth / 2, x.current.children[1].position.x = 0, x.current.children[1].position.y = 0, u && (x.current.children[2].position.x = -g.mawWidth / 2, x.current.children[2].position.y = g.heightText / 2)
                    },
                    S = () => {
                        r = new s.Shape,
                            function(e, t, n, r, o, i) {
                                let a = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : .75,
                                    c = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : .6,
                                    l = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : .2;
                                r += a, o += c, t -= r / 2, n -= o / 2, e.moveTo(t, n + i), e.lineTo(t, n + o - i), e.quadraticCurveTo(t, n + o, t + i, n + o), e.lineTo(t + r - i, n + o), e.quadraticCurveTo(t + r, n + o, t + r, n + o - i), e.lineTo(t + r, n + l), e.lineTo(t + r - l, n), e.lineTo(t + i, n), e.quadraticCurveTo(t, n, t, n + i)
                            }(o = new s.Shape, 0, 0, g.mawWidth, g.heightText, .15),
                            function(e, t, n, r, o, i) {
                                let a = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : .75,
                                    c = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : .6,
                                    l = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : .15;
                                r += a, o += c, t -= r / 2, n -= o / 2, e.moveTo(t + r, n + l), e.lineTo(t + r, n), e.lineTo(t + r - l, n), e.lineTo(t + r, n + l)
                            }(r, 0, 0, g.mawWidth, g.heightText, .15), w({
                                backShape: o,
                                borderShape: r
                            })
                    };
            ...
            let v = e => {
                    let {
                        ...
                        bgw: 0,
                        t: 0
                    }), []), [p, d] = (0, l.useState)(new s.Color(16777215)), [y, v] = (0, l.useState)(t === (0, a.PR)().id ? (0, a.PR)().name : ""), [w, b] = (0, l.useState)(""), [M] = (0, x.Z)(["/sounds/npc/pnj-voice-chat-1.opus", "/sounds/npc/pnj-voice-chat-1.mp3"], {
                        html5: !0
                        ...
                        html5: !0
                    }), B = [M, V, S, j, T], [R, C] = (0, l.useState)(!1);
                    (0, c.zX)("hideMessages_".concat(t), () => {
                        ...
                        for (let l = 2; l >= 0; l--) i[l] && i[l].message && (n || i[l].time + 5e3 > window.performance.now()) && (a += ("\n" !== a ? "\n" : "") + i[l].message);
                        B[s.MathUtils.randInt(0, 4)](), C(!1), r.hasMessage = !0, b(a), (0, c.Kn)("hide_name_".concat(t), {
                            hide: !0
                        })
                        ...
                        R && (r.hasMessage = !1, b(""), (0, c.Kn)("hide_name_".concat(t), {
                            hide: !1
                        }))
                    }, [t, R]), (0, u.A)(() => {
        ...
        5110: function(e, t, n) {
            ...
            let {
                clamp: o
            } = r.MathUtils, i = (e, t, n) => n - t == 0 ? 1 : o((e - t) / (n - t), 0, 1);
        ...
        9796: function(e, t, n) {
            ...
            let y = (e, t) => "".concat((Math.round(e * Math.pow(10, t || 2)) / Math.pow(10, t || 2)).toFixed(t || 2)),
                h = e => {
                    let {
                        entity: t
                    } = e, n = (0, c.useRef)(null), a = (0, c.useRef)(null), l = (0, c.useMemo)(() => new o.Vector3, []);
                    return (0, i.A)(e => {
                        let {
                            camera: r
                        } = e, o = n.current, i = a.current;
                ...
                m = e => {
                    ...
                    return (0, r.jsx)("group", {
                        renderOrder: 9999,
                        children: t.current.dynamic.map(e => (0, r.jsx)(h, {
                            entity: e
                        }, e.uuid))
                    })
                };
            ...
            function w(e) {
                ...
                }), [b, n, o, g, w, s, u]), S = (0, c.useCallback)((0, l.Z)(e => {
                ...
                let T = (0, i.z)(e => e.clock),
                    B = 0,
                    R = (0, c.useCallback)((0, l.Z)(e => {
                        let {
                            testExperience: t
                        } = (0, x.VB)();
                        if (!y && !M.current && t) {
                            let r = T.getElapsedTime() - B,
                                o = Math.floor(Math.min(n * (r / .016666666666666666) * 1, 60)),
                                i = Math.min(r, 1);
                            for (let c = 1; c <= o; c++)(0, a.Kn)("physicUpdateRaf", {
                                delta: i / o
                        ...
                        B = T.getElapsedTime()
                    }, 16.666666666666668), [y, M.current]);
                return (0, i.A)(R, -1), (0, r.jsxs)(v.Provider, {
                    value: V,
        ...
        2746: function(e, t, n) {
            ...
            let s = (e, t) => {
                ...
                return (0, o.useEffect)(() => {
                    if (!e) return;
                    let o = e.physic;
                    if (o) return o.visible = s.physic, s.bvh && (u.current = new i.y(o, 10), u.current.displayParents = !1, u.current.edgeMaterial.color = new r.Color(t || 16711680), n.add(u.current)), () => {
                        u.current && (u.current.dispose(), n.remove(u.current))
                    }
                }, [e, s.physic, s.bvh]), (0, c.zX)("physicDebugInfosRaf", () => {
            ...
            let b = function(e) {
                    ...
                    return (0, o.useEffect)(() => {
                        ...
                        if (_.name = i.name || "entity_".concat(a ? a.ref.uuid : "character"), i.hitbox) {
                            ...
                            d.scale(1, 2, 1), d.boundsTree = new c.r(d, {
                                lazyGeneration: !1
                            }), t.physic = new r.Mesh(d, j)
                        } else if (t instanceof r.Group) {
                            let y = [];
                            if (t.updateMatrixWorld(), t.traverse(e => {
                                    if (e.geometry) {
                            ...
                            m.applyMatrix4(t.matrixWorld), m.boundsTree = new c.r(m, {
                                lazyGeneration: !1
                            }), t.physic = new r.Mesh(m, j)
                        }
                        return "dynamic" === i.type && (M(t.physic, j), V(t.physic, j), i.position && (i.position[1] += 2), t.physic.position.copy(t.position), t.physic.transformer = new r.Object3D, t.physic.quaternionGravity = new r.Quaternion, t.physic.positionGravity = new r.Vector3, t.quaternion.length() > 0 && t.physic.quaternion.copy(t.quaternion), t.physic.position.y += 2, window.player = t), t.physic.visible = T.physic, t.physic.type = i.type, t.physic.api = k.current, t.physic.api.entity = t, t.physic.userData.ref = t, o[i.type].push(t.physic), n.add(t.physic), () => {
                            t.physic.wallBox && t.physic.remove(t.physic.wallBox), t.physic.jumpBox && t.physic.remove(t.physic.jumpBox), n.remove(t.physic), o[i.type] = o[i.type].filter(function(e) {
                        ...
                        (0, s.zX)("physicUpdateRaf", r => {
                            ...
                            let {
                                ...
                                acceleration: v,
                                gravityAcceleration: w
                            } = e;
                            if (!t || !t.physic) return;
                            let {
                                physic: b
                            } = t;
                            "dynamic" !== g || c || (b.orbital ? (d.copy(b.position), d.sub(b.orbital), d.normalize()) : b.attractor ? d.copy(b.attractor) : d.copy(u), h.copy(d), y.copy(u), f.setFromUnitVectors(y, h), m.copy(h), m.multiplyScalar(-a), m.toArray(n.gravity), f.multiply(b.transformer.quaternion), b.quaternionGravity.slerpQuaternions(b.quaternionGravity, f, 10 * o), h.applyQuaternion(b.quaternionGravity), b.positionGravity.add(h), b.quaternion.copy(b.quaternionGravity)), x && x({
                                entity: t,
                                physic: b,
                                api: e
                            }, o), "dynamic" !== g || c || (v = p(a, s, n.gravity), l.x = l.x - l.x * i, l.z = l.z - l.z * i, l.y = l.y - l.y * i, l.x += o * v[0] / a, l.y += o * v[1] / a, l.z += o * v[2] / a, e.deltaPosition.copy(l), b.translateX(l.x * o), b.translateY(l.y * o), b.translateZ(l.z * o), b.updateMatrixWorld())
                        })
                    }(k.current, e.current), ! function(e, t) {
                        let {
                            debug: n,
                            bodies: a
                        } = (0, o.useContext)(i.h), c = (0, o.useMemo)(() => new r.Box3, []), l = (0, o.useMemo)(() => new r.Line3, []), u = (0, o.useMemo)(() => new r.Matrix4, []), p = (0, o.useMemo)(() => new r.Matrix4, []), d = (0, o.useMemo)(() => new r.Matrix4, []), y = (0, o.useMemo)(() => new r.Vector3, []);
                        (0, s.zX)("physicCollideRaf", n => {
                            ...
                            let w = !1,
                                ...
                                M = a.current;
                            if (M) {
                                l.copy(s.segment), l.start.applyMatrix4(v.matrixWorld), l.end.applyMatrix4(v.matrixWorld), c.expandByPoint(l.start), c.expandByPoint(l.end), c.min.addScalar(-s.radius), c.max.addScalar(s.radius);
                                for (let V = 0; V < M.static.length; V++) {
                                    let S = M.static[V];
                                    if (!S.api.enabled) continue;
                                    let j = l.clone(),
                                        T = c.clone();
                                    if (S.api.matrixUpdate && (d.copy(S.matrix).invert(), j.start.applyMatrix4(d), j.end.applyMatrix4(d), T.min.applyMatrix4(d), T.max.applyMatrix4(d)), S && !S.api.sleep && S.geometry.boundsTree) {
                                        ...
                                        let z = new r.Vector3;
                                        v.geometry.boundingBox.getCenter(z), S.geometry.boundsTree.shapecast({
                                            ...
                                            intersectsTriangle: (t, n, r, o) => {
                                                ...
                                                if (i < s.radius) {
                                                    let a = s.radius - i,
                                                        c = f.sub(m);
                                                    S.api.isSticky ? e.entity.physic.attractor = c.normalize() : e.entity.physic.attractor = null, l.start.addScaledVector(c, a), l.end.addScaledVector(c, a), e.isColliding = !0, e.isFlying = !1, e.collider = S, S.api.isColliding = !0
                                                }
                                            }
                                        })
                                    }
                                ...
                                if (e.canJump = w, e.canFly = e.canFly ? e.canFly : e.canJump, e.hitWall = b, e.isColliding || (e.collider = null), e.collider) {
                                    ...
                                    W && (p.copy(e.collider.matrixWorld).invert(), l.start.applyMatrix4(p)), _ && e.isColliding && (y.set(0, 0, 0), i.add(y.set(_[0], _[1], _[2])), e.isColliding = !1, e.collider = null)
                                }(function(e, t, n) {
                                    for (let o = 0; o < e.zone.length; o++) {
                                        let i = e.zone[o];
                                        if (!i.api.enabled) continue;
                                        let a = t.clone();
                                        if (i.api.matrixUpdate && (x.copy(i.matrixWorld).invert(), a.min.applyMatrix4(x), a.max.applyMatrix4(x)), i && i.geometry.boundsTree && i.geometry.boundsTree.geometry) {
                                            let c = !1;
                                            if (i.geometry instanceof r.BoxGeometry) {
                                                let l = i.geometry.boundsTree.geometry.boundingBox;
                                                l && (c = l.containsBox(a))
                                            } else i.geometry.boundsTree.shapecast({
                                                intersectsBounds: e => (c || (c = e.intersectsBox(a)), c)
                                            });
                                            c ? !n.zones[i.name] && i.api && i.api.onEnterZone && (i.api.onEnterZone({
                                                collider: i
                                            }), n.zones[i.name] = i) : n.zones[i.name] && i.api && i.api.onLeaveZone && (i.api.onLeaveZone({
                                                collider: i
                                            }), delete n.zones[i.name])
                                        }
                                    }
                                })(M, c, e), m.copy(l.start)
                            }
                        })
                    }(k.current, e.current), ! function(e, t) {
                        let {
                            params: n
                        } = (0, o.useContext)(i.h), a = (0, o.useMemo)(() => new r.Vector3, []), c = (0, o.useMemo)(() => new r.Vector3, []), l = (0, o.useMemo)(() => new r.Vector3, []);
                        (0, o.useMemo)(() => new r.Vector3, []), (0, o.useMemo)(() => new r.Object3D, []), (0, s.zX)("physicCollideRaf", n => {
                            let {
                                delta: r
                            } = n, {
                                isMoving: o,
                            ...
                            if (a.set(0, 0, 0), "dynamic" === i && !d) {
                                p && u.applyMatrix4(p.matrixWorld), s ? ((0, v.SG)(m, l), y.subVectors(u, l)) : (y.set(0, 0, 0), e.initPosition = !0), e.onGround = y.y > Math.abs(r * e.velocity.y * .05);
                    ...
                    }(k.current, e.current), (0, g.Z)(e.current), [k.current]
                },
                M = (e, t) => {
                    ...
                    i.scale(.5, 1, .5);
                    let a = new r.Matrix4().setPosition(o.addVectors(n.min, n.max).multiplyScalar(.5));
                ...
                V = (e, t) => {
                    ...
                    let o = new r.Vector3().subVectors(n.max, n.min),
                        ...
                        a = new r.Matrix4().setPosition(o.addVectors(n.min, n.max).multiplyScalar(.5));
                    i.applyMatrix4(a), i.rotateX(-Math.PI / 2), i.scale(1, .25, .35), i.boundsTree = new c.r(i), e.wallBox = new r.Mesh(i, t), e.add(e.wallBox), e.wallBox.visible = !0
                }
        },
        6086: function(e, t, n) {
            n.d(t, {
        ...
        9497: function(e, t, n) {
            ...
            let p = c.forwardRef((e, t) => {
                ...
                return (0, r.jsx)("utsuboBasicImpl", {
                    ref: (0, s.Z)([a, t]),
                    glsl: o.GLSL3,
                    side: o.FrontSide,
                    ...i,
